...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Panthera | Dashboard</title>
                            ...
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="{{ url('admin/settings') }}">
                                        <div class="clearfix">
                                            <span class="pull-left">All Settings</span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
        ...
        <ul class="nav nav-list">
            ...
            <li class="nav-item start">
                <a href="{{ url('admin/categories') }}" class="nav-link">
                    ...
                    <span class="menu-text"> Categories Dashboard </span>
            ...
            <li class="">
                <a href="widgets.html" class="nav-link ">
                    ...
                    <span class="menu-text"> Orders Dashboard </span>
                </a>
            </li>
        ...
        <div class="footer-inner">
            <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Panthera</span>
